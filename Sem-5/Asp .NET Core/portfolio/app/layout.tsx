...
export const metadata: Metadata = {
  title: 'Jevin Morad - Full-Stack Developer',
  description:
  ...
  authors: [{ name: 'Jevin Morad' }],
  creator: 'Jevin Morad',
  openGraph: {
    title: 'Jevin Morad - Full-Stack Developer Portfolio',
    description:
    ...
    siteName: 'Jevin Morad - Portfolio',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
        height: 630,
        alt: 'Jevin Morad - Full-Stack Developer Portfolio',
      },
    ],
    locale: 'en_US',
    type: 'website',
